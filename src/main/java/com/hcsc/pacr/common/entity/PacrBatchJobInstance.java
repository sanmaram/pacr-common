...
public class PacrBatchJobInstance implements Serializable {
     ...
     * @return True if other object is instance of class PacrBatchJobInstance and the key objects are equal
     */
    ...
    public boolean equals(Object other) {
        if (!(other instanceof PacrBatchJobInstance)) return false;
